...
function removeLocalAuth() {
  ...
  console.log('Removed deepseek-auth.json. Chrome profile kept to avoid unnecessary browser logout.');
}
function printHelp() {
  divider();
  ...
  console.log('Without options, an interactive menu is launched.');
  divider();
}
async function menu() {
  while (true) {
