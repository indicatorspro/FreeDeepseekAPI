...
=======
  console.log('Deleted deepseek-auth.json. Chrome profile left to avoid logging out browser unnecessarily.');
}
function printHelp() {
  divider();
  ...
  console.log('  --help      Справка');
  console.log('Without options, interactive menu starts.');
>>>>>>> Stashed changes
  divider();
}
async function menu() {
