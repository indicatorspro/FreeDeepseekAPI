...
async function main() {
    ...
    console.log(
        '\n[auth] Chrome opened. Log into DeepSeek in THIS separate window.',
    );
    console.log(
        '[auth] After login, send a short message in DeepSeek, e.g.: ok',
    );
    await ask(
        '[auth] When logged in and sent test message — press ENTER here: ',
    );
